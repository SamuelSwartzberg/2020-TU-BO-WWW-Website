console.log(Cite.plugins);
let config = Cite.plugins.config.get('csl');
config.templates.add('apa-modified-year', `<?xml version="1.0" encoding="utf-8"?>
<style xmlns="http://purl.org/net/xbiblio/csl" class="in-text" version="1.0" demote-non-dropping-particle="never" page-range-format="expanded">
  <info>
    <title>American Psychological Association 6th edition modified name (year)</title>
    <title-short>APAmod</title-short>
    <id>1111</id>
    <author>
